...
namespace SharpSnmpLib.DTLS
{
    ...
    {
        public static ISnmpMessage GetSecureResponse(this ISnmpMessage request, int timeout, IPEndPoint receiver)
        {
            ...
            return request.GetSecureResponse(timeout, receiver, registry);
        }
        ...
        /// <returns></returns>
        public static ISnmpMessage GetSecureResponse(this ISnmpMessage request, int timeout, IPEndPoint receiver, UserRegistry registry)
        {
            if (request == null)
            {
            ...
            client.PSKIdentities.AddIdentity(Encoding.UTF8.GetBytes("oFIrQFrW8EWcZ5u7eGfrkw"), ByteTool.Convert("7CCDE14A5CF3B71C0C08C8B7F9E5"));
