...
namespace Lextm.SharpSnmpLib.Mib
{
	...
	public sealed class SharpMibException : SharpSnmpException
	{
		...
		SharpMibException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if (info == null)
			{
		...
		public override string Details
		{
			get
			{
				return string.Format(CultureInfo.InvariantCulture,
				                     "wrong symbol {0}. Row {1}. Column: {2}",
				                     _symbol.ToString(), _symbol.Row, _symbol.Column);
			}
		}
		/// <summary>
