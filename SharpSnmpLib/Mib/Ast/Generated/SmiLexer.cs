...
// $ANTLR 3.4.1.9004 Smi.g 2011-12-24 17:19:58
...
public partial class SmiLexer : Antlr.Runtime.Lexer
{
	...
	private void mUPPER()
	{
		...
		try
		{
			int _type = UPPER;
			int _channel = DefaultTokenChannel;
			// Smi.g:556:2: ( ( 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' | '-' | '0' .. '9' ) )* )
			DebugEnterAlt(1);
			// Smi.g:556:6: ( 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' | '-' | '0' .. '9' ) )*
			{
			DebugLocation(556, 6);
			...
			while (true)
			{
				...
				if ((LA9_1=='-'||(LA9_1>='0' && LA9_1<='9')||(LA9_1>='A' && LA9_1<='Z')||(LA9_1>='a' && LA9_1<='z')))
				{
					alt9 = 1;
				}
	...
	private void mLOWER()
	{
		...
		try
		{
			int _type = LOWER;
			int _channel = DefaultTokenChannel;
			// Smi.g:561:2: ( ( 'a' .. 'z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' | '-' | '0' .. '9' ) )* )
			DebugEnterAlt(1);
			// Smi.g:561:4: ( 'a' .. 'z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' | '-' | '0' .. '9' ) )*
			{
			DebugLocation(561, 4);
			if ((input.LA(1)>='a' && input.LA(1)<='z'))
			{
			...
			while (true)
			{
				...
				if ((LA10_1=='-'||(LA10_1>='0' && LA10_1<='9')||(LA10_1>='A' && LA10_1<='Z')||(LA10_1>='a' && LA10_1<='z')))
				{
					alt10 = 1;
				}
		...
		private static readonly string[] DFA15_transitionS =
			{
				...
				"\x1\x101",
				"\x1\x102",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x12\x28\x1\x103\x7\x28\x6\xFFFF\x1A"+
				"\x28",
				"\x1\x105",
				"\x1\x106",
				"\x1\x107",
				...
				"\x1\x12D",
				"\x1\x12E",
				"\x1\x12F\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x131\x2\xFFFF\xA\x28\x7\xFFFF\x14\x28\x1\x132\x5\x28\x6\xFFFF\x1A"+
				"\x28",
				"\x1\x134",
				"\x1\x135",
				"\x1\x136",
				...
				"\x1\x20F",
				"\x1\x210",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x12\x28\x1\x211\x7\x28\x6\xFFFF\x1A"+
				"\x28",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x214",
				"\x1\x215",
				...
				"\x1\x24D",
				"\x1\x24E",
				"\x1\x24F\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x251",
				"",
				"",
				"\x1\x252",
				...
				"\x1\x297",
				"\x1\x298",
				"\x1\x299\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x29B",
				"\x1\x29C",
				"\x1\x29D\x2\xFFFF\xA\x28\x7\xFFFF\x12\x28\x1\x29E\x7\x28\x6\xFFFF\x1A"+
				"\x28",
				"\x1\x2A0",
				"\x1\x2A1",
				"",
				...
				"\x1\x2C5",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\xD\x28\x1\x2C7\xC\x28\x6\xFFFF\x1A"+
				"\x28",
				"",
				"",
				"\x1\x2C9",
				...
				"\x1\x372",
				"\x1\x373",
				"\x1\x374\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x377",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x379",
				...
				"\x1\x395",
				"\x1\x396",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x12\x28\x1\x397\x7\x28\x6\xFFFF\x1A"+
				"\x28",
				"\x1\x399",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x39B",
				...
				"\x1\x39F",
				"\x1\x3A0",
				"\x1\x3A1\x2\xFFFF\xA\x28\x7\xFFFF\x12\x28\x1\x3A2\x7\x28\x6\xFFFF\x1A"+
				"\x28",
				"\x1\x3A4",
				"",
				"",
				...
				"\x1\x41A",
				"\x1\x41B",
				"\x1\x41C\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"\x1\x41E",
				"\x1\x28\x2\xFFFF\xA\x28\x7\xFFFF\x1A\x28\x6\xFFFF\x1A\x28",
				"",
				"\x1\x420",
