...
namespace Lextm.SharpSnmpLib
{
    ...
    /// REPORT message.
    /// </summary>
    public class ReportMessage : ISnmpMessage, IDisposable
    {
        ...
        /// <summary>
        /// Finalizer of <see cref="ReportMessage"/>.
        /// </summary>
        ~ReportMessage()
        {
            Dispose(false);
        ...
        /// <summary>
        /// Releases all resources used by the <see cref="ReportMessage"/>.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Disposes of the resources (other than memory) used by the <see cref="ReportMessage"/>.
        /// </summary>
