...
public sealed class GetNextRequestMessage : ISnmpMessage, ILegacyV3Request
{
    ...
    /// <summary>
    /// Initializes a new instance of GetNextRequestMessage (legacy, no contextName).
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of GetNextRequestMessage (legacy, no contextName, with maxMessageSize).
    /// </summary>
    [Obsolete("Please use overloads with contextName.")]
    public GetNextRequestMessage(
        VersionCode version,
