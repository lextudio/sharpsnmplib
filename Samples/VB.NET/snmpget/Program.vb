...
Module Program
    Sub Main(ByVal args As String())
                                                                                                           ...
                                                                                                           End Sub).Add("d", "-d to display message dump",
                                                                                                                        ...
                                                                                                                        End Sub).Add("t:", "-t for timeout value (unit is second).",
                                                                                                                                     ...
                                                                                                                                     End Sub).Add("r:", "-r for retry count (default is 0)",
                                                                                                                                                  ...
                                                                                                                                                  End Sub).Add("v|version:", "-v for SNMP version (v1, v2 and v3 are currently supported)",
                                                                                                                                                               Sub(v As String)
        ...
        Try
            ...
            Dim request As New GetRequestMessage(VersionCode.V3, Messenger.NextMessageId, Messenger.NextRequestId, New OctetString(user), vList, record, _
             report)
