...
Module Program
    Public Sub Main(ByVal args As String())
                                                                                                                                            ...
                                                                                                                                            End Sub).Add("V", "-V to display version number of this application.",
                                                                                                                                                         ...
                                                                                                                                                         End Sub).Add("t:", "-t for timeout value (unit is second).",
                                                                                                                                                                      ...
                                                                                                                                                                      End Sub).Add("r:", "-r for retry count (default is 0)",
                                                                                                                                                                                   ...
                                                                                                                                                                                   End Sub).Add("v:", "-v for SNMP version (v1, v2 and v3 are currently supported)",
                                                                                                                                                                                                Sub(v As String)
        ...
        Try
            ...
            Dim request As New SetRequestMessage(VersionCode.V3, 100, 0, New OctetString(user), vList, record, _
                                                 report)
