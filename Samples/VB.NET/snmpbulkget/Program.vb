...
Module Program
    Public Sub Main(ByVal args As String())
        ...
        Try
            ...
            Dim request As New GetBulkRequestMessage(VersionCode.V3, Messenger.NextMessageId, Messenger.NextRequestId, New OctetString(user),  New OctetString(IF(string.IsNullOrWhiteSpace(contextName), String.Empty, contextName)), nonRepeaters, maxRepetitions, _
            ...
            If TypeOf reply Is ReportMessage Then
                ...
                request = New GetBulkRequestMessage(VersionCode.V3, Messenger.NextMessageId, Messenger.NextRequestId, New OctetString(user),  New OctetString(IF(string.IsNullOrWhiteSpace(contextName), String.Empty, contextName)), nonRepeaters, maxRepetitions, _
