...
4. Execute prepare.bat under SharpSnmpLib folder to prepare necessary files.
...
2. Use terminal to execute prepare.sh under SharpSnmpLib folder to prepare necessary files.
