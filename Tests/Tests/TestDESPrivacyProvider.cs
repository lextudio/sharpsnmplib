    ...
    public class TestDESPrivacyProvider
    {
        ...
        public void TestDecrypt()
        {
            byte[] encrypted = ByteTool.ConvertByteString("4B  4F 10 3B 73  E1 E4 BD 91  32 1B CB 41" +
                 ...
                 "FB 04 A4");
            byte[] real = new DESPrivacyProvider(OctetString.Empty, null).Decrypt(encrypted, new byte[] { 0x37, 0xc6, 0x4c, 0xad, 0x49, 0x37, 0xfe, 0xda, 0x57, 0xc8, 0x48, 0x53, 0x47, 0x2a, 0x2e, 0xc0 },
                20, 53, new byte[] { 0x00, 0x00, 0x00, 0x01, 0x44, 0x2c, 0xa3, 0xb5 });
        ...
        public void TestEncrypt()
        {
            ...
            byte[] fake = new DESPrivacyProvider(OctetString.Empty, null).Encrypt(decrypted, new byte[] { 0x37, 0xc6, 0x4c, 0xad, 0x49, 0x37, 0xfe, 0xda, 0x57, 0xc8, 0x48, 0x53, 0x47, 0x2a, 0x2e, 0xc0 },
                20, 53, new byte[] { 0x00, 0x00, 0x00, 0x01, 0x44, 0x2c, 0xa3, 0xb5 });
     ...
     "FB 04 A4");
            ...
            Scope scope = new Scope(engineId, OctetString.Empty, new GetRequestPdu(new Integer32(0x3A25), ErrorCode.NoError, new Integer32(0), new List<Variable>() { new Variable(new ObjectIdentifier("1.3.6.1.2.1.1.3.0")) }));
