...
namespace Lextm.SharpSnmpLib.Tests
{
    ...
    public class TestTrapMessage
    {
        ...
        public void TestSendTrap()
        {
            ...
            ISnmpMessage parsed = MessageFactory.ParseMessages(bytes, UserRegistry.Default)[0];
        ...
        public void TestParseNoVarbind()
        {
            ...
            ISnmpMessage m = MessageFactory.ParseMessages(buffer, UserRegistry.Default)[0];
