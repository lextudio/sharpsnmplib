...
class TestGet
{
	...
	static void Main(string[] args)
	{
        ...
        try
        {            
            Variable variable = Manager.Get(VersionCode.V1, new IPEndPoint(IPAddress.Parse(ip), 161), "public", new List<Variable>() {test}, 5000)[0];
        ...
        try
        {  
            Variable v2 = Manager.Get(VersionCode.V2, new IPEndPoint(IPAddress.Parse(ip), 161), "public", new List<Variable>() {test}, 5000)[0];
