...
Module Program
    Public Sub Main(ByVal args As String())
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         End Sub).Add("V", "-V to display version number of this application.", Sub(v As String)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                End Sub).Add("t:", "-t for timeout value (unit is second).", Sub(v As String)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             End Sub).Add("r:", "-r for retry count (default is 0)", Sub(v As String)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     End Sub).Add("v:", "-v for SNMP version (v2 and v3 are currently supported)", Sub(v As String)
        ...
        Try
            ...
            Dim request As New GetBulkRequestMessage(VersionCode.V3, 100, 0, New OctetString(user), nonRepeaters, maxRepetitions, _
             vList, record, report)
