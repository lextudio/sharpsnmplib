    ...
    internal static class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                SecureDiscovery discovery = new SecureDiscovery(Messenger.NextMessageId, Messenger.NextRequestId, 1000);
                ...
                ISnmpMessage reply = request.GetSecureResponse(timeout, receiver);
                if (dump)
                {
